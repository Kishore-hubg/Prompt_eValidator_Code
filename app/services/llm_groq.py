...
def llm_rewrite_prompt(
    ...
    *,
    ...
    system = (
        ...
        "      If the prompt is too terse to fill a section meaningfully:\n"
        "      → Write: '[Not specified in original — add before using]'\n"
        "      → Add to unresolved_gaps: 'Missing: <section name> not specified in original.'\n\n"
        ...
        "    Include language, framework, version, and relevant modules.\n"
        "    Only use [Specify:...] when the original truly names no tech stack.\n"
